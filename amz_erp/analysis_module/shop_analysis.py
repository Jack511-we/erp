# -*- coding: utf-8 -*-
"""
店铺分析模块：对店铺数据进行多维度统计与分析，支持异常值高亮、同比/环比
"""
import pandas as pd
from amz_erp.data_module.shop_data import get_shop_data
from amz_erp.utils import cache_result, catch_exception

@catch_exception
@cache_result
def analyze_shop(params=None):
    """
    店铺多维度分析接口
    ...
    # 多维度统计
    result = {}
    for dim in ['shop','sku','campaign','date']:
