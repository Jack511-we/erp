# -*- coding: utf-8 -*-
"""
广告系列分析模块：对广告系列数据进行多维度统计与分析，支持异常值高亮、同比/环比
"""
import pandas as pd
from amz_erp.data_module.campaign_data import get_campaign_data
from amz_erp.utils import cache_result, catch_exception

@catch_exception
@cache_result
def analyze_campaign(params=None):
    """
    广告系列多维度分析接口
    ...
    # 多维度统计
    result = {}
    for dim in ['campaign','sku','shop','date']:
